...
*Due: Monday, February 24, 2020 - one week!*
...
- [ ] In your **start.html** file, change the title in the TITLE tag to "Lab 8 - …" e.g.  `<title>Lab 8 - Shakespeare</title>`
...
- [ ] Add a class to the NAV element; the class name should reflect what you plan to do with it (Hint: keep it simple; call the class `"menu"` or `"main-menu"` …something like that)
...
- [ ] When styling a horizontal menu system, you can use any of the typical layout tools to get the list items to line-up horizontally: **inline-block**, **CSS table-cell**, or **CSS flex** (recommended) ...pick one and apply it to the menu's **LI**s or the **UL**, respectively, depending on which layout tool you're using
