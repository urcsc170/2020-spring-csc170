...
*Due: Monday, January 27, 2020* (before the next lab)
...
- Get an FPO image.  For our purposes, you need a small image, **no wider than say 200 pixels** or so, and the file type must be: *jpg*, *png* or *gif*. 

### Start filling your HTML file with content

Using the *comp* on the end of this document as a guide, you will write and paste text into your open HTML file (in your code editor) inside the `<body>` tag
